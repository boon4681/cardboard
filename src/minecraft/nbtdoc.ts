...
export const load = async (version: string, path: string = './nbtdoc') => {
    ...
    if (await versions_validator(version)) {
        const nbtdoc = `https://raw.githubusercontent.com/Yurihaia/mc-nbtdoc/${version}-gen/build/generated.json`
